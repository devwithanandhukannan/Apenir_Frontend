...
export const AuthGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const routeRule = isLoginPage ? undefined : ROLE_ROUTES.find((route) => path.startsWith(route.prefix));
  ...
  const isUnauthorized = routeRule && (!isAuthenticated || (user && user.role !== routeRule.allowedRole));
